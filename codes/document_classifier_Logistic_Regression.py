...
Title: Document classification in 2 classes using logistic regression algorithm (binary classifier) => 0 - personal query, 1 - question query 
features used : tfidf
"""
...
class NaiveBayes():
	...
	def train(self,):
		...
		self.clf = LogisticRegression(solver='liblinear', max_iter=11, multi_class='ovr', n_jobs=-1,random_state = 42)
