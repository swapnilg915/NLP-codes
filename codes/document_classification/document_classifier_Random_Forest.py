...
Title: Document classification in 2 classes using Random Forest algorithm (binary classifier) => 0 - personal query, 1 - question query 
features used : tfidf
"""
...
class RandomForest():
	...
	def train(self,):
		...
		# 	'n_estimators':[3,5,11,25,50,100,150,200,500],
		# 	'min_samples_leaf':[1,2,3,4,5]
		# }
		# self.clf = GridSearchCV(rf, grid_params)
		self.clf = RandomForestClassifier(max_features = 'auto', n_estimators = 500, min_samples_leaf = 2, criterion = 'gini')
...
if __name__ == '__main__':
		nb = RandomForest()
		nb.test("what is multi threading")
